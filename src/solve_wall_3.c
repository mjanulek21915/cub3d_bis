...
{
//  fprintf(stderr, "solve_wall_3_init_x\n");
	...
	solve->diry = -1;
	solve->sum_dist = 0;
//  fprintf(stderr, "\tsolve_wall_3_init_x ok : ");
//  print_solve(solve);
...
{
//  fprintf(stderr, "solve_wall_3_init_y\n");
...
//  fprintf(stderr, "solve_wall_3_init_y ok : \n");
//  print_solve(solve);
...
//  fprintf(stderr, "solve_wall_3 ok\n");
