...
void		solve_wall_7_init_x(float ati, float azi, t_map *map, t_solve *solve)
{
//  fprintf(stderr, "solve_wall_7_init_x\n");
	...
	solve->diry = 1;
	solve->sum_dist = 0;
//  fprintf(stderr, "\tsolve_wall_7_init_x ok : ");
//  print_solve(solve);

}

void		solve_wall_7_init_y(float ati, float azi, t_map *map, t_solve *solve)
{
//  fprintf(stderr, "solve_wall_7_init_y\n");
...
//  fprintf(stderr, "solve_wall_7_init_y ok : \n");
//  print_solve(solve);
...
//  fprintf(stderr, "solve_wall_7\n");
	...
	solve_wall_7_init_x(ati, azi, map, &solve_x);
	solve_wall_7_init_y(ati, azi, map, &solve_y);
